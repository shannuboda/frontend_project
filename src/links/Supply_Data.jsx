...
/>
 ...
 {marksheetData.filter((student) => !isPrintMode || student.checked).map((student, index) => (
   
   <tr key={index}>
     <td><input type="checkbox" name="" id={index+1} checked={student.checked} onChange={() => handleCheckboxChange(student.id)}/></td>
     <td>{student.name}</td>
